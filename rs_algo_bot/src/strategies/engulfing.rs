...
impl<'a> Strategy for Engulfing<'a> {
    fn new(
    ...
    fn entry_long(
        ...
        let entry_condition = candle.candle_type() == &CandleType::BearishEngulfing && is_closed;
    ...
    fn entry_short(
        ...
        let entry_condition = candle.candle_type() == &CandleType::Engulfing && is_closed;
