...
options=("build & deploy all" "build all" "deploy all" "build & deploy rs-algo-ws-server" "build & deploy rs-algo-bot" "build & deploy rs-algo-ws-server/bot backtest" "Quit")
...
do
    case $opt in
        ...
        "build & deploy rs-algo-bot")
            ...
            break
            ;;
        "build & deploy rs-algo-ws-server/bot backtest")
            echo "Deploying: $opt";
